...
struct MappingParameters
{
  ...
  double cloud_body_x_, cloud_body_y_, cloud_body_z_;
  double cloud_body_roll_, cloud_body_pitch_, cloud_body_yaw_;
  double cloud_exclusion_radius_, cloud_exclusion_height_;
